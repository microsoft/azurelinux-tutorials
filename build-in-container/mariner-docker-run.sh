...
mkdir -p ${repo_dir}/build/rpm_cache/cache
mkdir -p ${repo_dir}/build/toolchain_rpms
mkdir -p ${repo_dir}/ccache
mkdir -p ${repo_dir}/logs
mkdir -p ${repo_dir}/out
mkdir -p ${repo_dir}/toolkit
...
mount_pts="
    -v $repo_dir/SPECS:/mariner/SPECS:rw \
    -v $repo_dir/toolkit:/mariner/toolkit:rw \
    -v $tool_dir/scripts:/mariner/scripts:rw \
    -v $repo_dir/build/rpm_cache/cache:/temp/DockerStage/docker-chroot-1/upstream-cached-rpms:rw \
    -v $repo_dir/ccache:/temp/DockerStage/docker-chroot-1/ccache-dir:rw \
    ...
    -v $repo_dir/build/rpm_cache/cache:/temp/DockerStage/docker-chroot-2/upstream-cached-rpms:rw \
    -v $repo_dir/ccache:/temp/DockerStage/docker-chroot-2/ccache-dir:rw \
    ...
    -v $repo_dir/build/rpm_cache/cache:/temp/DockerStage/docker-chroot-3/upstream-cached-rpms:rw \
    -v $repo_dir/ccache:/temp/DockerStage/docker-chroot-3/ccache-dir:rw \
    ...
    -v $repo_dir/build/rpm_cache/cache:/temp/DockerStage/docker-chroot-4/upstream-cached-rpms:rw \
    -v $repo_dir/ccache:/temp/DockerStage/docker-chroot-4/ccache-dir:rw \
    ...
    -v $repo_dir/build/rpm_cache/cache:/temp/DockerStage/docker-chroot-5/upstream-cached-rpms:rw \
    -v $repo_dir/ccache:/temp/DockerStage/docker-chroot-5/ccache-dir:rw \
    ...
    -v $repo_dir/build/rpm_cache/cache:/temp/DockerStage/docker-chroot-6/upstream-cached-rpms:rw \
    -v $repo_dir/ccache:/temp/DockerStage/docker-chroot-6/ccache-dir:rw \
    ...
    -v $repo_dir/build/rpm_cache/cache:/temp/DockerStage/docker-chroot-7/upstream-cached-rpms:rw \
    -v $repo_dir/ccache:/temp/DockerStage/docker-chroot-7/ccache-dir:rw \
    ...
    -v $repo_dir/build/rpm_cache/cache:/temp/DockerStage/docker-chroot-8/upstream-cached-rpms:rw \
    -v $repo_dir/ccache:/temp/DockerStage/docker-chroot-8/ccache-dir:rw \
    ...
    -v $repo_dir/build/rpm_cache/cache:/temp/DockerStage/docker-chroot-9/upstream-cached-rpms:rw \
    -v $repo_dir/ccache:/temp/DockerStage/docker-chroot-9/ccache-dir:rw \
    ...
    -v $repo_dir/build/rpm_cache/cache:/temp/DockerStage/docker-chroot-10/upstream-cached-rpms:rw \
    -v $repo_dir/ccache:/temp/DockerStage/docker-chroot-10/ccache-dir:rw \
    ...
    -v $repo_dir/build/rpm_cache/cache:/temp/DockerStage/docker-chroot-11/upstream-cached-rpms:rw \
    -v $repo_dir/ccache:/temp/DockerStage/docker-chroot-11/ccache-dir:rw \
    ...
    -v $repo_dir/build/rpm_cache/cache:/temp/DockerStage/docker-chroot-12/upstream-cached-rpms:rw \
    -v $repo_dir/ccache:/temp/DockerStage/docker-chroot-12/ccache-dir:rw \
    ...
    -v $repo_dir/build/rpm_cache/cache:/mariner/build/rpm_cache/cache:rw \
    -v $repo_dir/build/toolchain_rpms:/mariner/build/toolchain_rpms:rw \
    -v $repo_dir/out:/mariner/out:rw \
    -v $repo_dir/logs:/mariner/logs:rw \
    -v /dev:/dev:ro \
    -v /sys:/sys:ro
    "
